    ...
    <footer className="bg-[#ffffff] border-t border-[#1e1c12]">
      <div className="max-w-7xl mx-auto px-6 py-14">
        <div className="grid md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              <span style={{ fontSize: "20px", color: "#FFD60A", fontWeight: 600 }}>
                sama <span style={{ color: "#1D4ED8" }}>sema</span>
              </span>
            </div>
            <p style={{ fontSize: "15px", color: "#6a6560", lineHeight: 1.7, maxWidth: "320px" }}>
          ...
          {/* Links */}
          <div>
            <p style={{ fontSize: "12px", color: "#FFD60A", fontWeight: 600, letterSpacing: "0.1em" }} className="uppercase mb-5">
              Services
            </p>
            <ul className="space-y-3">
              {["Classic Photobox", "Open Air Setup","Custom Branding", "Digital Gallery"].map((item) => (
                <li key={item}>
                  <a href="#services" style={{ fontSize: "14px", color: "#6a6560" }} className="hover:text-[#c9c4b8] transition-colors">
                    {item}
                  </a>
                </li>
              ))}
          ...
          <div>
            <p style={{ fontSize: "12px", color: "#1D4ED8", fontWeight: 600, letterSpacing: "0.1em" }} className="uppercase mb-5">
              Company
            </p>
            <ul className="space-y-3">
              {[
                ...
                <li key={item.label}>
                  <a href={item.href} style={{ fontSize: "14px", color: "#6a6560" }} className="hover:text-[#c9c4b8] transition-colors">
                    {item.label}
                  </a>
                </li>
              ))}
        ...
        <div className="pt-8 border-t border-[#1e1c12] flex flex-col sm:flex-row items-center justify-between gap-4">
          <p style={{ fontSize: "13px", color: "#4a4640" }}>
            © 2026 SamaSema Ltd. All rights reserved.
          </p>
          <div className="flex gap-6">
            {["Privacy Policy", "Terms of Service", "Cookie Policy"].map((item) => (
              <a key={item} href="#" style={{ fontSize: "13px", color: "#4a4640" }} className="hover:text-[#6a6560] transition-colors">
                {item}
              </a>
            ))}
          </div>
