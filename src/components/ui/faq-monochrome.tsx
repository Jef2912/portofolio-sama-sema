...
export function FAQ1() {
  ...
  return (
    <div id="faq" className={`relative w-full overflow-hidden transition-colors duration-700 ${palette.surface}`}>
      {/* Top transition from Contact (#FFD60A) */}
      <div className="absolute top-0 left-0 right-0 h-48 bg-gradient-to-b from-[#FFD60A] to-transparent pointer-events-none z-20" />
      <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#2a2820] to-transparent relative z-30" />
      ...
      <section
        className={`relative z-10 mx-auto flex max-w-4xl flex-col gap-12 px-6 pt-40 pb-24 lg:max-w-5xl lg:px-12 ${
      ...
      >
        ...
        >
          ...
          <span className="faq1-intro__label">Important FAQs</span>
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className="relative flex w-full items-start justify-start gap-4 md:gap-6 px-6 py-5 md:px-8 md:py-7 text-left transition-colors duration-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[var(--faq-outline)]"
                >
                  <span
                    className={`relative flex h-10 w-10 md:h-12 w-12 shrink-0 items-center justify-center rounded-full border transition-all duration-500 group-hover:scale-105 ${palette.iconRing} ${palette.iconSurface}`}
                  >
                    <span
                  ...
                  <div className="flex flex-1 flex-col gap-4">
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
                      ...
                      {item.meta && (
                        <span
                          className={`inline-flex items-center rounded-full border px-3 py-1 text-[10px] uppercase tracking-[0.35em] transition-opacity duration-300 sm:ml-auto ${palette.border} ${palette.muted}`}
                        >
                          {item.meta}
                        </span>
                      )}
